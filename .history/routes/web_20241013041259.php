...
Route::get('delete', function () {
    ...
    //// ==
    $user = User::whereIn('id', [15, 255, 265])->delete(); // Return the number of deleted records->integer->1
    //// ==
    // $user = User::destroy([2, 3, 8]);// Return the number of deleted records->integer->3
    dd($user);
});
