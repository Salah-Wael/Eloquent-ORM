...
Route::get('delete', function(){
    ...
    //// ==
    // $user = User::destroy(6);// // Return the number of deleted records->integer->3

    $user = User::find([2, 3, 8])->delete();// Return the number of deleted records->integer->3
    // $user = User::destroy(6);// boolean->ture
    dd($user);
});
